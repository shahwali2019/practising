<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="add_new_custome.aspx.cs" Inherits="practising.add_new_custome" %>
...
<%--	<div class="col-sm-6">
	...
	<br />
	<asp:Button ID="BtnSubmit" runat="server" Text="ADD" Class="btn btn-success" Width="100%" Font-Names="Bahnschrift" OnClick="BtnSubmit_Click" />
</asp:Content>
